...
bool Server::SetUP(int PORT=1111, bool BroadcastPublically=false) {
	//Winsock Startup
	WSAData wsaData;
...
bool Server::ListenForNewConnection()
{
	...
	else //If client connection properly accepted
	{
		...
		std::string MOTD = "Welcome! Done by Tomer Eyzenberg!.";
...
float Server::getP2_Y() {
	return P2_y;
}

void Server::setP1_Y(float x) {
	P1_y = x;
}
void Server::setP2_Y(float x) {
	P2_y = x;
}
